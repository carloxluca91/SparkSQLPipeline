...
case class CsvOptions(schema: List[CsvColumnSpecification], separator: Option[String], header: Option[String]) {
...
case class CsvColumnSpecification(name: String, dataType: String, nullable: Boolean)
