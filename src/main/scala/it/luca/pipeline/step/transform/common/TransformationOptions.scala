...
import it.luca.pipeline.step.transform.option.{DropColumnTransformationOptions, SelectTransformationOptions,
  WithColumnRenamedTransformationOptions, WithColumnTransformationOptions}
