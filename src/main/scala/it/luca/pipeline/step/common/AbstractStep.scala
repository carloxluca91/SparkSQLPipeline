...
object AbstractStep extends JsonDecodeSubTypes[AbstractStep]{

  implicit val AbstractStepDecodeJson: DecodeJson[AbstractStep] = decodeSubTypes(JsonField.StepType.label,
